...
# Files to update
REGISTRY_JSON="$REPO_ROOT/extras/claude-code/shared/hooks/skills-registry.json"
...
Updated:
- extras/claude-code/shared/hooks/skills-registry.json
...
main() {
    ...
    echo "    https://github.com/dsouzaAnush/salesforce-skills/releases/tag/$new_version"
    echo ""
}

...
TARGETS=(
  ...
  "null"
  "scripts/__pycache__"
  "extras/claude-code/shared/__pycache__"
  "extras/claude-code/shared/code_analyzer/__pycache__"
  "extras/claude-code/shared/hooks/scripts/__pycache__"
  "extras/claude-code/shared/lsp-engine/__pycache__"
  "extras/claude-code/tools/__pycache__"

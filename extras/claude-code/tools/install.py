...
HOOKS_SRC_DIR = "extras/claude-code/shared/hooks"
LSP_ENGINE_SRC_DIR = "extras/claude-code/shared/lsp-engine"
SKILLS_REGISTRY = "extras/claude-code/shared/hooks/skills-registry.json"
AGENTS_DIR = "extras/claude-code/agents"  # FDE + PS agent definitions
...
def is_sf_skills_hook(hook: Dict[str, Any]) -> bool:
    ...
    SF_SKILLS_INDICATORS = (
        "sf-skills", "shared/hooks", "extras/claude-code/shared/hooks", ".claude/hooks",
        "shared\\hooks", "extras\\claude-code\\shared\\hooks", ".claude\\hooks",
    )
...
""")
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if not dry_run:
            ...
            installer_source = source_dir / "extras" / "claude-code" / "tools" / "install.py"
...
{c('✅ Uninstallation complete!', Colors.GREEN)}
   ...
   To reinstall:
   curl -sSL https://raw.githubusercontent.com/{GITHUB_OWNER}/{GITHUB_REPO}/main/extras/claude-code/tools/install.py | python3
═══════════════════════════════════════════════════════════════════
""")
...
def cmd_status() -> int:
    ...
    if state == InstallState.FRESH:
        ...
        print(f"\nTo install:")
        print(f"  curl -sSL https://raw.githubusercontent.com/{GITHUB_OWNER}/{GITHUB_REPO}/main/extras/claude-code/tools/install.py | python3")
        return 1
    ...
    if state == InstallState.NPX:
        ...
        print(f"  curl -sSL https://raw.githubusercontent.com/{GITHUB_OWNER}/{GITHUB_REPO}/main/extras/claude-code/tools/install.sh | bash")
        return 0

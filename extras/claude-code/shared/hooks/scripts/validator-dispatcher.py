  ...
  "PostToolUse": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "python3 ./extras/claude-code/shared/hooks/scripts/validator-dispatcher.py",
          "timeout": 10000
        }
      ]
    }
...
# Get the base directory (extras/claude-code/shared/hooks/scripts/)
SCRIPT_DIR = Path(__file__).parent
SHARED_HOOKS_DIR = SCRIPT_DIR.parent  # extras/claude-code/shared/hooks/

...
> **This is not an anti-AI stance. This is an anti-spam stance.**
>
> The maintainers of this project use AI tools daily. We welcome quality contributions regardless of how they're made. What we don't welcome is low-effort, bulk-generated content that shifts the verification burden onto maintainers.

### Rules for AI-Assisted Contributions

#### Issues & Discussions
- ✅ **Allowed**: AI-assisted drafting that you've personally reviewed and refined
- ✅ **Allowed**: Using AI to help articulate a problem you genuinely encountered
- ❌ **Not Allowed**: Bulk-generated "feedback" or "reviews" submitted without human thought
- ❌ **Not Allowed**: AI-generated issues that promote external products or services
- ❌ **Not Allowed**: Template-based issues submitted across multiple projects

#### Pull Requests
- ✅ **Allowed**: AI-assisted code that you've tested and verified yourself
- ✅ **Allowed**: PRs linked to previously accepted issues
- ❌ **Not Allowed**: Drive-by PRs with AI-generated content and no prior discussion
- ❌ **Not Allowed**: Unsolicited refactoring or "improvements" generated by AI

### Disclosure
If your contribution involves significant AI assistance, briefly mention it. We appreciate transparency.

### Enforcement
- **Bulk AI-generated issues/PRs will be closed immediately**
- **Marketing disguised as feedback will result in user blocking**
- **Repeat violations may result in permanent bans**

### Why This Policy?

The rise of agentic AI tools has made it trivially easy to mass-generate "contributions" that create work for maintainers rather than helping. A 13-issue spam campaign that takes 13 minutes to generate takes hours to review and close. This policy protects volunteer maintainer time.

**Quality over quantity. Thought over automation. Contribution over noise.**
...
python3 extras/claude-code/tools/install.py --dry-run
```

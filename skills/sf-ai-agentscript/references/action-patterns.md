...
*Consolidated from @kunello's [PR #20](https://github.com/dsouzaAnush/salesforce-skills/pull/20) research on Agent Script Recipes action configuration patterns.*
